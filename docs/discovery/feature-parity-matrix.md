...
| Chord            | 140 canonical files, immutable commit fetch, cache/SWR/pinning | IMPLEMENTED / NEEDS VERIFICATION | Chord audit: 140/140 files, 3191/3191 mapped, zero orphan/invalid; device parity remains.                    |
