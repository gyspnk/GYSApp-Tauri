  ...
  return (
    ...
    >
      ...
      >
        ...
        <details className="hymn-more-actions">
          <summary className="hymn-more-actions-summary">Lainnya</summary>
        ...
        <details className="hymn-reader-settings">
          <summary className="hymn-reader-settings-summary">
            Pengaturan baca
          </summary>
