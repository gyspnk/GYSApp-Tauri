...
The current production baseline is approximately 78.1 KiB gzip for the main
application chunk and 140.6 KiB gzip for all initial JavaScript; PDF.js and its
